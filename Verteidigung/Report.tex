...
\author{Hannes Bachmann\\
  4847472\\
  INF BAS \\
  \texttt{hannes.bachmann@mailbox.tu-online.de} 
  \\%\And
  Julia Rennert \\
  4924490\\
  INF-VERT2 \\
...
\caption{figure}{The two most prevalent GAN approaches as depicted by \cite{triantafyllopoulos_overview_2023}}
\end{figure}
...
\caption{figure}{Depiction of the general method of our two approaches}
\label{Ablauf}
\end{figure}
...
\caption{figure}{GUI of the implementation}
\end{figure}
